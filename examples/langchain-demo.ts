            ...
            try {
                ...
                connectionMonitor
                    ...
                    .catch((error) =>
                        ...
                        console.error('Background connection monitor failed to start or encountered an error:', error)
                    );
            } catch (err) {
...
async function chatLoop() {
    ...
    while (true) {
        ...
        if (userInput.toLowerCase() === 'exit') {
            ...
            if (connectionMonitor && typeof connectionMonitor.stopMonitoring === 'function') {
